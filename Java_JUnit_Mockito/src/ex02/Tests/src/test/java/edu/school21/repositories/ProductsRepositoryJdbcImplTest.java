...
public class ProductsRepositoryJdbcImplTest {
    ...
    final List<Product> EXPECTED_FIND_ALL_PRODUCTS = Arrays.asList(
            new Product(0, "Mars", 50),
            new Product(1, "Snickers", 100),
            new Product(2, "Nuts", 500),
            new Product(3, "Bounty", 5000),
            new Product(4, "Shit", 10000)
    );
    ...
    public void testFindAll(){
        ...
        assertThrows(RuntimeException.class, () -> wrongProductsRepository.findAll());
    }
